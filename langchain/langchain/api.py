...
async def local_doc_chat(
        ...
        question: str = Body(..., description="Question", example="吃披萨"),
        history: List[List[str]] = Body(
            ...
            example=[
                [
                    "吃披萨",
                    "披萨是一种美味的食物！有各种口味和配料可供选择。你可以选择经典的披萨口味，如芝士披萨、蔬菜披萨、意大利香肠披萨等，或者尝试一些特色口味，如海鲜披萨、牛肉披萨、夏威夷披萨等",
                ]
            ],
        ),
):
...
if __name__ == "__main__":
    #这个 API 是前端向后端通信的接口。它定义了一组路由和对应的处理函数，用于处理前端发送的请求并返回相应的响应数据。
